...
public abstract class AbstractAnalyzerBlockEntity extends LockableContainerBlockEntity implements SidedInventory, RecipeUnlocker, RecipeInputProvider, Tickable {
    ...
    protected AbstractAnalyzerBlockEntity(BlockEntityType<?> blockEntityType, RecipeType<? extends AbstractCookingRecipe> recipeType) {
        ...
        this.propertyDelegate = new PropertyDelegate() {
            public int get(int index) {
                switch(index) {
                    case 0:
                        return AbstractAnalyzerBlockEntity.this.burnTime;
                    case 1:
                        return AbstractAnalyzerBlockEntity.this.fuelTime;
                    case 2:
                        return AbstractAnalyzerBlockEntity.this.cookTime;
                    case 3:
                        return AbstractAnalyzerBlockEntity.this.cookTimeTotal;
                    default:
                        return 0;
                }
            }
            ...
            public void set(int index, int value) {
                switch(index) {
                    case 0:
                        AbstractAnalyzerBlockEntity.this.burnTime = value;
                        break;
                    case 1:
                        AbstractAnalyzerBlockEntity.this.fuelTime = value;
                        break;
                    case 2:
                        AbstractAnalyzerBlockEntity.this.cookTime = value;
                        break;
                    case 3:
                        AbstractAnalyzerBlockEntity.this.cookTimeTotal = value;
                }
