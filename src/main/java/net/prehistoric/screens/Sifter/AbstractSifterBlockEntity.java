...
public abstract class AbstractSifterBlockEntity extends LockableContainerBlockEntity implements SidedInventory, RecipeUnlocker, RecipeInputProvider, Tickable {
    ...
    protected AbstractSifterBlockEntity(BlockEntityType<?> blockEntityType, RecipeType<? extends AbstractCookingRecipe> recipeType) {
        ...
        this.propertyDelegate = new PropertyDelegate() {
            public int get(int index) {
                switch(index) {
                    case 0:
                        return AbstractSifterBlockEntity.this.burnTime;
                    case 1:
                        return AbstractSifterBlockEntity.this.fuelTime;
                    case 2:
                        return AbstractSifterBlockEntity.this.cookTime;
                    case 3:
                        return AbstractSifterBlockEntity.this.cookTimeTotal;
                    default:
                        return 0;
                }
            }
            ...
            public void set(int index, int value) {
                switch(index) {
                    case 0:
                        AbstractSifterBlockEntity.this.burnTime = value;
                        break;
                    case 1:
                        AbstractSifterBlockEntity.this.fuelTime = value;
                        break;
                    case 2:
                        AbstractSifterBlockEntity.this.cookTime = value;
                        break;
                    case 3:
                        AbstractSifterBlockEntity.this.cookTimeTotal = value;
                }
