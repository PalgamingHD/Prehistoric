...
public abstract class AbstractArcheologyWorkbenchBlockEntity extends LockableContainerBlockEntity implements SidedInventory, RecipeUnlocker, RecipeInputProvider, Tickable {
    ...
    protected AbstractArcheologyWorkbenchBlockEntity(BlockEntityType<?> blockEntityType, RecipeType<? extends AbstractCookingRecipe> recipeType) {
        ...
        this.propertyDelegate = new PropertyDelegate() {
            public int get(int index) {
                switch(index) {
                    case 0:
                        return AbstractArcheologyWorkbenchBlockEntity.this.burnTime;
                    case 1:
                        return AbstractArcheologyWorkbenchBlockEntity.this.fuelTime;
                    case 2:
                        return AbstractArcheologyWorkbenchBlockEntity.this.cookTime;
                    case 3:
                        return AbstractArcheologyWorkbenchBlockEntity.this.cookTimeTotal;
                    default:
                        return 0;
                }
            }
            ...
            public void set(int index, int value) {
                switch(index) {
                    case 0:
                        AbstractArcheologyWorkbenchBlockEntity.this.burnTime = value;
                        break;
                    case 1:
                        AbstractArcheologyWorkbenchBlockEntity.this.fuelTime = value;
                        break;
                    case 2:
                        AbstractArcheologyWorkbenchBlockEntity.this.cookTime = value;
                        break;
                    case 3:
                        AbstractArcheologyWorkbenchBlockEntity.this.cookTimeTotal = value;
                }
    ...
    public static Map<Item, Integer> createFuelTimeMap() {
        ...
        addFuel(map, Prehistoric.RELIC_SCRAP, 100);
        return map;
    }
